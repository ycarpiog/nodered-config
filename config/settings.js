...
const fs = require("fs");
const httpsEnabled = process.env.NODERED_ENABLE_HTTPS === "true";
...
const buildAdminUsers = () => {
    ...
    for (let i = 1; i <= 4; i += 1) {
        const username = process.env["NODERED_USERNAME_" + i];
        const password = process.env["NODERED_PASSWORD_HASH_" + i] || fallbackHashes[i];
...
module.exports = {
   ...
   functionGlobalContext: {
      //LoggerFactory: require("/data/lib/logger.js"),
//    mainLogger: require("/data/lib/logger.js").getLogger("SYSTEM", true, "info"),
},
 ...
 ******************************************************************************/
     ...
     */
    //httpNodeAuth: {user:"user",pass:"REPLACE_WITH_BCRYPT_HASH"},
    //httpStaticAuth: {user:"user",pass:"REPLACE_WITH_BCRYPT_HASH"},
